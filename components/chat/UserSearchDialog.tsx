...
import { Search, Loader2, MessageSquarePlus, X, Clock } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import type { ChatUserSearchResult } from "@/lib/types/models";
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        {trigger || (
          <Button variant="default" size="sm" className="gap-2 w-auto  md:w-full">
