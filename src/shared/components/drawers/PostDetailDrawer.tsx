...
/**
 * PostDetailDrawer - Full Post Detail Drawer
 *
 * Features:
 ...
 *
 * Use Case:
 * - Universal drawer for ALL posts (with or without media)
 * - Shows complete post content + interactions
 */
  ...
  return (
    <Drawer open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
      <DrawerContent className="h-screen data-[vaul-drawer-direction=bottom]:max-h-[95vh]">
        ...
        >
          {/* Media Section - Edge-to-Edge (if available) */}
