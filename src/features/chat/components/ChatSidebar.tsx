          ...
          >
            <div className="relative h-5 w-5">
              ...
              <Image
                ...
                width={20}
                height={20}
                className="object-contain dark:hidden group-hover:opacity-70 transition-opacity"
              />
              ...
              <Image
                ...
                width={20}
                height={20}
                className="object-contain hidden dark:block group-hover:opacity-70 transition-opacity"
              />
            </div>
