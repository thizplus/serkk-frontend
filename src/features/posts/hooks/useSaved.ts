...
export function useSavePost() {
  ...
  return useMutation({
    ...
    onSuccess: (data, postId) => {
      ...
      // Toast notification
      toast.success(TOAST_MESSAGES.POST.SAVE_SUCCESS);
    },
    onError: (error, postId, context) => {
      toast.error(TOAST_MESSAGES.POST.SAVE_ERROR);
...
export function useUnsavePost() {
  ...
  return useMutation({
    ...
    onSuccess: (data, postId) => {
      ...
      // Toast notification
      toast.success(TOAST_MESSAGES.POST.UNSAVE_SUCCESS);
    },
    onError: (error) => {
      toast.error(TOAST_MESSAGES.POST.UNSAVE_ERROR);
