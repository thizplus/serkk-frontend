...
/**
 * POC #6: Comment-Only Drawer
 *
 * Technology:
 * - Drawer: Shadcn UI Drawer component (Vaul library)
 * - Layout: Vertical scroll (comments only)
 * - Vote: VoteButtons for post
 * - Comments: CommentForm + CommentTree
 *
 * Purpose:
 * - Triggered by clicking comment icon on post
 * - Shows ONLY comments section (no media)
 * - Perfect for quick comment interaction
 *
 * Pros:
 * - ✅ Fast access to comments
 * - ✅ Clean, focused UI
 * - ✅ Swipe down to dismiss
 * - ✅ Full comment interaction
 */
export function POC6_CommentDrawer({
  post,
  open,
  onClose,
}: CommentDrawerProps) {
